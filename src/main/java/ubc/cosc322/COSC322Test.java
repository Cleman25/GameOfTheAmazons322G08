...
=======
    	ArrayList<int[]> bestMove=ai.getBestMove(game.getBoardState(),1,Integer.MIN_VALUE,Integer.MAX_VALUE,game.getPlayer()==2);
>>>>>>> f504604763e4b6e8c17ba4be2e4daf22de614d9c
